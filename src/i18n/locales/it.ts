export default {
  ...
  profile: {
    ...
    userInfo: {
      ...
      description: 'I dettagli del tuo account',
      nickname: 'Nickname',
      nicknameHint: 'Questo è il tuo identificativo unico e non può essere modificato',
    },
    language: {
      title: 'Lingua',
    ...
    theme: {
      title: 'Tema',
      description: 'Scegli tra modalità chiara e scura',
    },
    password: {
      title: 'Cambia Password',
      description: 'Aggiorna la tua password per mantenere il tuo account sicuro',
      ...
      errors: {
        ...
        updateFailed: 'Aggiornamento password fallito',
      },
    },
    deleteAccount: {
      title: 'Elimina Account',
      description: 'Elimina permanentemente il tuo account e tutti i dati',
      warning: 'Attenzione: Questa azione non può essere annullata',
      consequences: {
        dataLoss: 'Tutti i tuoi dati saranno eliminati permanentemente',
        searchHistory: 'Il tuo storico di ricerca andrà perso',
        irreversible: 'Questa azione è irreversibile',
      },
      deleteButton: 'Elimina Il Mio Account',
      confirmTitle: 'Sei assolutamente sicuro?',
      confirmDescription: 'Questo eliminerà permanentemente il tuo account e tutti i dati associati. Questa azione non può essere annullata.',
      passwordLabel: 'Inserisci la tua password per confermare',
      passwordPlaceholder: 'La tua password',
      confirmButton: 'Sì, Elimina Il Mio Account',
      cancelButton: 'Annulla',
      deleting: 'Eliminazione',
      errors: {
        passwordRequired: 'La password è necessaria per eliminare il tuo account',
